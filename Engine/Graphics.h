...
public:
	...
	void draw_square(int x, int y, int size, Color c);
	void draw_square(int x, int y, int size, int r, int g, int b)
	{
		draw_square(x, y, size, { unsigned char(r),unsigned char(g),unsigned char(b) });
	}
	void draw_square(int x, int y, int size, Color body, Color padding);
